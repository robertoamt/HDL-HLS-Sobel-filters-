...
xilinx.com:hls:edge_detect:1.0\
xilinx.com:ip:processing_system7:5.5\
xilinx.com:hls:rgb2gray:1.0\
xilinx.com:ip:proc_sys_reset:5.0\
xilinx.com:hls:u8tou32:1.0\
...
proc create_root_design { parentCell } {
  ...
  set edge_detect_0 [ create_bd_cell -type ip -vlnv xilinx.com:hls:edge_detect:1.0 edge_detect_0 ]
  ...
  # Create instance: u8tou32_0, and set properties
  set u8tou32_0 [ create_bd_cell -type ip -vlnv xilinx.com:hls:u8tou32:1.0 u8tou32_0 ]
  ...
  connect_bd_intf_net -intf_net axi_dma_0_M_AXIS_MM2S [get_bd_intf_pins axi_dma_0/M_AXIS_MM2S] [get_bd_intf_pins rgb2gray_0/stm_in]
  ...
  connect_bd_intf_net -intf_net edge_detect_0_strm_out [get_bd_intf_pins edge_detect_0/strm_out] [get_bd_intf_pins u8tou32_0/stm_in]
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M01_AXI [get_bd_intf_pins ps7_0_axi_periph/M01_AXI] [get_bd_intf_pins rgb2gray_0/s_axi_CTRL_PORT]
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M02_AXI [get_bd_intf_pins edge_detect_0/s_axi_CTRL_PORT] [get_bd_intf_pins ps7_0_axi_periph/M02_AXI]
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M03_AXI [get_bd_intf_pins ps7_0_axi_periph/M03_AXI] [get_bd_intf_pins u8tou32_0/s_axi_CTRL_PORT]
  connect_bd_intf_net -intf_net rgb2gray_0_stm_out [get_bd_intf_pins edge_detect_0/strm_in] [get_bd_intf_pins rgb2gray_0/stm_out]
  connect_bd_intf_net -intf_net u8tou32_0_stm_out [get_bd_intf_pins axi_dma_0/S_AXIS_S2MM] [get_bd_intf_pins u8tou32_0/stm_out]

  # Create port connections
  connect_bd_net -net axi_dma_0_mm2s_introut [get_bd_pins axi_dma_0/mm2s_introut] [get_bd_pins xlconcat_0/In0]
  connect_bd_net -net axi_dma_0_s2mm_introut [get_bd_pins axi_dma_0/s2mm_introut] [get_bd_pins xlconcat_0/In1]
  connect_bd_net -net edge_detect_0_interrupt [get_bd_pins edge_detect_0/interrupt] [get_bd_pins xlconcat_0/In3]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins axi_dma_0/m_axi_mm2s_aclk] [get_bd_pins axi_dma_0/m_axi_s2mm_aclk] [get_bd_pins axi_dma_0/s_axi_lite_aclk] [get_bd_pins axi_mem_intercon/ACLK] [get_bd_pins axi_mem_intercon/M00_ACLK] [get_bd_pins axi_mem_intercon/S00_ACLK] [get_bd_pins axi_mem_intercon/S01_ACLK] [get_bd_pins edge_detect_0/ap_clk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins processing_system7_0/S_AXI_HP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/M01_ACLK] [get_bd_pins ps7_0_axi_periph/M02_ACLK] [get_bd_pins ps7_0_axi_periph/M03_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rgb2gray_0/ap_clk] [get_bd_pins rst_ps7_0_100M/slowest_sync_clk] [get_bd_pins u8tou32_0/ap_clk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_ps7_0_100M/ext_reset_in]
  connect_bd_net -net rgb2gray_0_interrupt [get_bd_pins rgb2gray_0/interrupt] [get_bd_pins xlconcat_0/In2]
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins axi_dma_0/axi_resetn] [get_bd_pins axi_mem_intercon/ARESETN] [get_bd_pins axi_mem_intercon/M00_ARESETN] [get_bd_pins axi_mem_intercon/S00_ARESETN] [get_bd_pins axi_mem_intercon/S01_ARESETN] [get_bd_pins edge_detect_0/ap_rst_n] [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/M01_ARESETN] [get_bd_pins ps7_0_axi_periph/M02_ARESETN] [get_bd_pins ps7_0_axi_periph/M03_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rgb2gray_0/ap_rst_n] [get_bd_pins rst_ps7_0_100M/peripheral_aresetn] [get_bd_pins u8tou32_0/ap_rst_n]
  connect_bd_net -net u8tou32_0_interrupt [get_bd_pins u8tou32_0/interrupt] [get_bd_pins xlconcat_0/In4]
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x43C10000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs edge_detect_0/s_axi_CTRL_PORT/Reg] SEG_edge_detect_0_Reg
  create_bd_addr_seg -range 0x00010000 -offset 0x43C00000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs rgb2gray_0/s_axi_CTRL_PORT/Reg] SEG_rgb2gray_0_Reg
  create_bd_addr_seg -range 0x00010000 -offset 0x43C20000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs u8tou32_0/s_axi_CTRL_PORT/Reg] SEG_u8tou32_0_Reg
